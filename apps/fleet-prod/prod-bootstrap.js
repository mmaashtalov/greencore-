...
const modules=[
  './app.js?v=20260814-1',
  './ux-runtime-v2.js?v=20260815-1',
  './ux-loading-v1.js?v=20260815-1',
  './ui-patch.js?v=20260815-4',
  './ux-bridge.js?v=20260815-2',
  './ux-polish-v2.js?v=20260815-3',
  './ux-dialog-v1.js?v=20260816-6',
  './ux-empty-v1.js?v=20260815-1',
  './ux-feedback-v1.js?v=20260815-1',
  './ux-freshness-v1.js?v=20260815-1',
  './ux-navigation-v1.js?v=20260815-1',
  './ux-return-state-v1.js?v=20260815-1',
  './ux-notify-v1.js?v=20260815-1',
  './ux-inbox-v1.js?v=20260816-5',
  './ux-login-v1.js?v=20260816-2',
  './ux-validation-v1.js?v=20260816-7',
  './ux-form-guard-v1.js?v=20260816-3',
  './ux-accessibility-v1.js?v=20260815-2',
  './ux-role-loader-v1.js?v=20260817-60',
  './maintenance-rules-admin-v1.js?v=20260816-1',
  './pwa-patch.js?v=20260815-2'
];
for(const src of modules) await import(src);
window.dispatchEvent(new CustomEvent('fleet:prod-bootstrap-ready',{detail:{version:'2026.08.17-bootstrap1'}}));
