const UXSB_VERSION='2026.08.15-session2';
...
function beforeLogout(){const uid=userId()||localStorage.getItem(KEYS.owner);if(uid)stash(uid);localStorage.removeItem(KEYS.owner);sessionStorage.removeItem(KEYS.ctx);scheduleReload()}
